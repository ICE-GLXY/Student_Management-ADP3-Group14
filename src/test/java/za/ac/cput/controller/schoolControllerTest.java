...
public class schoolControllerTest {
        ...
        @Order(2)
        void read(){
            String url = baseURL + "readSchool/" + school1.getSchoolCode();
            System.out.println(url);
        ...
        @Order(3)
        void delete(){
            String url = baseURL + "deleteSchool/" + school1.getSchoolCode();
            System.out.println(url);
            this.restTemplate.delete(url);
            assertAll(
                    () -> assertSame("B141", school1.getSchoolCode()),
                    () -> assertNotNull(school1.getSchoolCode())
            );
        }
